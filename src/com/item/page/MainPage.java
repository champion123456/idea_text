...
import com.item.dao.GsalesDao;
import com.item.dao.SalesManDao;
import com.item.entity.Goods;
import com.item.entity.Gsales;
import com.item.entity.SalesMan;
import com.item.tools.Arith;
import com.item.tools.QueryPrint;
import com.item.tools.ScannerChoice;
...
public final class MainPage extends ScannerChoice {
	...
	public static void mainPage() {
		...
		do {
			...
			System.out.println("重新输入或者按0退出系统");
		} while (true);
	}
